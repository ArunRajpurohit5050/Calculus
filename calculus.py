...
st.write("**AMD   -   47.17%  -  48.38%   10150**")
st.write("**DIS   -   53.22%  -  54.43%   9996**")
st.write("**NFLX  -   47.58%  -  49.19%   9865**")
st.write("**TSLA  -   47.58%  -  52.01%   9850**")
st.write("**GME   -   50.40%  -  52.41%   10005**")
st.write("**RBLX  -   45.96%  -  47.58%   9873**")
st.write("**SONY  -   52.01%  -  54.03%   9996**")
st.write("**SBUX  -   49.19%  -  51.61%   9991**")
st.write("**INTC  -   52.01%  -  52.82%   10047**")
st.write("**IBM   -   54.03%  -  55.24%   9900**")
st.write("**JNJ   -   59.67%  -  60.48%   10383**")
st.write("**BA    -   52.41%  -  54.43%   10380**")