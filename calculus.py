...
st.subheader("Name    Low      High   Simulation(money)")
st.write(f"AAPL  -   50.40%  -  52.41%   10083")
st.write(f"META  -   51.61%  -  52.82%   9168")
st.write(f"NVDA  -   47.38%  -  51.20%   10225")
st.write(f"AMD   -   47.17%  -  48.38%   10150")
st.write(f"DIS   -   53.22%  -  54.43%   9996")
st.write(f"NFLX  -   47.58%  -  49.19%   9865")
st.write(f"TSLA  -   47.58%  -  52.01%   9850")
st.write(f"GME   -   50.40%  -  52.41%   10005")
st.write(f"RBLX  -   45.96%  -  47.58%   9873")
st.write(f"SONY  -   52.01%  -  54.03%   9996")
st.write(f"SBUX  -   49.19%  -  51.61%   9991")
st.write(f"INTC  -   52.01%  -  52.82%   10047")
st.write(f"IBM   -   54.03%  -  55.24%   9900")
st.write(f"JNJ   -   59.67%  -  60.48%   10383")
st.write(f"BA    -   52.41%  -  54.43%   10380")